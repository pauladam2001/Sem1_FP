...
class Rental:
    ...
    def __str__(self):
        return 'Rental id: ' + self._rental_id + ', Book id: ' + self._book_id_rental + ', Client id: ' + self._client_id_rental +\
               ', Rented date: ' + self._rented_date + ', Returned date: ' + self._returned_date
