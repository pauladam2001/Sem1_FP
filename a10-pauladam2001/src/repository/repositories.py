...
class BookRepository:
    ...
    def __init__(self):
        ...
        """
        self._bookList = IterableDataObject()
        #self._bookList = []
        #self.initial_books() # we generate books in start, so when we want to work with files we don't generate books everytime
...
class ClientRepository:
    ...
    def __init__(self):
        ...
        """
        self._clientList = IterableDataObject()
        #self._clientList = []
        #self.initial_clients() # we generate clients in start, so when we want to work with files we don't generate clients everytime
...
class RentalRepository:
    ...
    def __init__(self, bookList, clientList):
        ...
        """
        self._rentalList = IterableDataObject()
        #self._rentalList = []
        self._bookList = bookList
        self._clientList = clientList
        #self.initial_rentals() # we generate rentals in start, so when we want to work with files we don't generate rentals everytime
